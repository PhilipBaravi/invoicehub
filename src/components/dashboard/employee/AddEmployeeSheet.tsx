      ...
      <SheetContent className="overflow-y-auto">
        ...
        >
          ...
          <div className="flex space-x-2">
            ...
            >
              <SelectTrigger className="w-[120px]" id="selectCountryTrigger">
                <SelectValue
                  placeholder={
          ...
          <div>
            <Label htmlFor="dateOfEmployment">
              {t("addEmployee.dateOfEmployment")}
            </Label>
            <Popover>
              <PopoverTrigger asChild id="dateOfEmployment">
                ...
                >
                  ...
                  {newEmployee.dateOfEmployment ? (
                    format(newEmployee.dateOfEmployment, "PPP")
                  ) : (
                    <span>{t("addEmployee.pirckADate")}</span>
                  )}
                </Button>
              </PopoverTrigger>
