...
const ProductsPage: FC = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await fetch("https://api.invoicehub.space/product/list", {
        method: "GET",
        headers: {
  ...
  const handleAddProduct = async () => {
    ...
    try {
      const response = await fetch("https://api.invoicehub.space/product/create", {
        method: "POST",
        headers: {
  ...
  const handleEditProduct = async () => {
    if (editingProduct && editingProduct.id) {
      try {
        const response = await fetch(`https://api.invoicehub.space/product/update/${editingProduct.id}`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${keycloak.token}`,
  ...
  const handleDeleteProduct = async (productId: number) => {
    try {
      const response = await fetch(`https://api.invoicehub.space/product/delete/${productId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${keycloak.token}`,
        },
